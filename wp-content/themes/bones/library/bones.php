...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
		...
		wp_register_style( 'bones-slider-style', get_stylesheet_directory_uri() . '/library/css/jquery.parallax-slider.css', array(), '' );
    ...
    if ( is_singular() AND comments_open() AND (get_option('thread_comments') == 1)) {
		...
		wp_register_script( 'bones-animate', get_stylesheet_directory_uri() . '/library/js/libs/jquery.animate-colors.js', array('jquery'), true );
		...
		wp_enqueue_style( 'bones-slider-style' );
		...
		*/
		...
		wp_enqueue_script( 'bones-animate' );
